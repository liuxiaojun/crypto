...
def test_multiple_symbols_ccxt():
    ...
    # ]
        ...
        # 主流Layer1公链
        "ETHUSDT", "BNBUSDT", "SOLUSDT", "AVAXUSDT", "ADAUSDT", "DOTUSDT",
        "TONUSDT", "NEARUSDT", "APTUSDT", "SUIUSDT", "ICPUSDT", "INJUSDT",
        "SEIUSDT", "TIAUSDT", "ATOMUSDT", "TRXUSDT", "XRPUSDT", "XLMUSDT",
        "HBARUSDT",
        ...
        # DeFi龙头
        "UNIUSDT", "AAVEUSDT", "CRVUSDT", "LDOUSDT", "JUPUSDT", "CAKEUSDT",
        "PENDLEUSDT", "ENAUSDT",
        ...
        # 预言机/AI/渲染
        "LINKUSDT", "FETUSDT", "RENDERUSDT", "PYTHUSDT",
            ...
            for i in range(max_requests):
                ...
                try:
                    ...
                    if end_time is None:
                        ...
                        ohlcv = exchange.fetch_ohlcv(ccxt_symbol, '1h', since=None, limit=limit, params={'endTime': end_time - 1})
        ...
        if all_data:
            ...
            # 分段保存数据
            print(f"\n--- 分段保存数据 ---")
            segments = [5000, 5000]  # 第一段2000条，第二段1000条
